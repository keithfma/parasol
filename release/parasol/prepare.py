...
# constants
PARASOL_HOME = os.path.expanduser(os.path.join('~', '.parasol'))
...
LIDAR_URLS_FILE = resource_filename('parasol', 'lidar.json')
OSM_BBOX_FILE = resource_filename('parasol', 'osm.json')
